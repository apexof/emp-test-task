export const predictionMarketFactory = {
  ...
  abi: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: 'uint256', name: 'cutoffDate', type: 'uint256' },
        { indexed: false, internalType: 'uint256', name: 'decisionDate', type: 'uint256' },
        { indexed: false, internalType: 'address', name: 'decisionProvider', type: 'address' },
